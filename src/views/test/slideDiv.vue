<!--
 * @Author: 杨旭晨
 * @Date: 2020-08-06 15:05:19
 * @Descripttion: 一个可以拖动的组件，分左右两个快
 * @LastEditors: 杨旭晨
 * @props leftMinWidth Number 左侧块最小宽度 单位px 默认200
 * @props rightMinWidth Number 右侧块最小宽度 单位px 默认200
 * @props show Boolean 是否显示两个滑块 true：显示 false：只显示左边的 默认true
 * @props leftWidth String 显示两个滑块时，初始化左侧所占比例 百分比形式 默认60%
 * @props rightWidth String 显示两个滑块时，初始化右侧所占比例 百分比形式 默认40%
 * @LastEditTime: 2020-08-06 18:12:24
-->
<template>
